      ...
      <Grid container spacing={0} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
        ...
        <Item style={{backgroundColor:'white',align:'left'}}>
            ...
            <Grid container spacing={2}>
              <Grid item xs={3}>
                <Typography style={{marginTop:'2px',fontSize:'20px',color:'black',fontWeight:'bold'}}>
                    Price
                  </Typography>
              </Grid>
              <Grid item xs={2}>
            ...
            <Typography style={{marginTop:'15px',fontSize:'20px',color:'black',fontWeight:'normal'}}>
                  Description
            </Typography>
            <Typography style={{marginTop:'10px',fontSize:'15px',color:'grey',marginRight:'20px'}}>
                  ...
                  .They can provide arthritis relief.The cherry is a fruit with substantial medicinal and nutritional qualities. 
             ...
             {/*} <Grid item xs={5}>
              ...
              <Box sx={{width: 800,height: 35,backgroundColor: '#ac8787',marginTop:'30px',marginLeft:'30px',marginBottom:'8px' }}>
